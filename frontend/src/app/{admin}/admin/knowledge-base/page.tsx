    ...
    <div className="h-full overflow-y-auto p-6 space-y-6">
      ...
      <form onSubmit={handleUpload}
        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          <div className="col-span-2">
            <label className="block text-xs font-medium text-gray-600 mb-1">Fichier (PDF / DOCX / JSON)</label>
            <input ref={fileRef} type="file" accept=".pdf,.docx,.doc,.json" required
      ...
      <div className="rounded-xl border bg-white overflow-hidden shadow-sm">
        <table className="w-full text-sm">
          ...
          <tbody className="divide-y">
            {loading && (
              <tr><td colSpan={6} className="px-4 py-4 text-center text-gray-400 text-xs">Chargement…</td></tr>
            )}
